...
// Reusable fade-in variant for project cards
...
const Project: React.FC<ProjectProps> = ({ isDarkMode }) => {
  const projects = useMemo(
    () => [
      {
        title: "Excalidraw Clone",
        description: "A collaborative whiteboard tool built with Next.js, TailwindCSS, and WebSocket.",
        image: "/dummy.png",
        github: "https://github.com/Aqib2110/Excalidraw-app",
        demo: "https://your-portfolio.vercel.app",
      },
      ...
      {
        title: "Second Brain App",
        description: "A personal knowledge management tool built with Next.js, TypeScript, and GraphQL.",
        image: "/dummy.png",
        github: "https://github.com/Aqib2110/second-brain-frontend",
        demo: "https://second-brain-frontend-tau.vercel.app/",
      },
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold mb-6 text-center text-blue-500">My Projects</h2>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 px-0">
        {projects.map((project, index) => (
          <MotionDiv
            key={project.title}
          ...
          >
            ...
            />
            <div className="p-4 px-0">
              <h3 className="text-xl text-center md:text-start font-semibold">{project.title}</h3>
              <p className="text-sm text-center xl:text-lg md:text-start overflow-hidden h-[50px] mt-2">
                {project.description}
              </p>
              <div className="flex flex-col md:flex-row gap-2 mt-4">
