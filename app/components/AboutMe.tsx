  ...
  return (
    ...
    >
      ...
      <div className="px-10 md:px-0">
        <MotionDiv className={`xl:text-2xl ${isDarkMode ? "text-white" : "text-black"} block md:hidden px-3 sm:px-0 text-lg md:text-start text-center`} variants={fadeInUpVariant}>
