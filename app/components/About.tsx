  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mb-4">
          I also have experience in DevOps and cloud technologies, including{" "}
          <span className="text-orange-400">Docker</span>,{" "}
          <span className="text-red-400">Kubernetes</span>, continuous integration
          and deployment (CI/CD), and cloud platforms like{" "}
